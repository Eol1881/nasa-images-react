...
export const serializeFormData = async (formData: FormData | IFormData) => {
  if (formData instanceof FormData) {
    ...
    const serializedFormEntries = Object.fromEntries(formData.entries()) as unknown as IFormData;
